      ...
      function ThreadProbe() {
        ...
        useLayoutEffect(() => {
          ...
          /* fork:begin fork-composer-shell — see .fork/customizations.yaml#fork-composer-shell
             ...
             upstream's predicate is always false here. What this case actually
             exercises is the scroll-collapse restore, so read that flag instead. */
          isResting = composer.isComposerScrollCollapsed;
