...
const ComposerFooterPrimaryActions = memo(function ComposerFooterPrimaryActions(props: {
  ...
  return (
    <>
      {/* fork:begin fork-composer-shell — see .fork/customizations.yaml#fork-composer-shell
          Upstream renders the ContextWindowMeter and the preparing-worktree
          readout here; the fork's shell renders both in its readoutControls
          slot (data-fork-composer-status) instead. */}
      {/* fork:end fork-composer-shell */}
        ...
        <div className="relative">
          ...
          >
            ...
            >
              ...
              {/* fork:begin fork-composer-shell — see .fork/customizations.yaml#fork-composer-shell
                Upstream's prompt-length validation, re-seated between the prompt
                row and the shell-owned control row. */}
