...
function ChatViewContent(props: ChatViewProps) {
  ...
  const onSend = async (
    ...
    /* fork:begin fork-design-mode — see .fork/customizations.yaml#fork-design-mode
       ...
       composer only ever showed the pill); a pure read — the entries are cleared
       via markSent once the turn start succeeds. */
                  ...
                  >
                    ...
                    >
                      ...
                      {/* Upstream renders the BranchToolbar strip here, wrapped in
                          a min-h-0 / data-terminal-open pair. The strip is the
                          composer's contextStrip prop instead, and the wrapper went
                          with it — nothing read data-terminal-open, so keeping the
