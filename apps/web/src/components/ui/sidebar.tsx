  ...
  return (
    <SidebarInstanceContext value={instanceContextValue}>
      ...
      >
        ...
        <div
          className={cn(
            /* fork:begin sidebar-offcanvas-compositing — see .fork/customizations.yaml#sidebar-offcanvas-compositing */
            "fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-[translate,width] duration-200 ease-linear md:flex",
            side === "left"
              ? "left-0 group-data-[collapsible=offcanvas]:-translate-x-full"
              : "right-0 group-data-[collapsible=offcanvas]:translate-x-full",
            /* fork:end sidebar-offcanvas-compositing */
