    ...
    return (
      <>
        ...
        <span
          ...
          className="inline-flex h-7 min-w-0 max-w-[48%] flex-1 items-center justify-start gap-1 border border-transparent px-[calc(--spacing(2)-1px)] text-sm font-medium text-muted-foreground/70 sm:h-6 md:hidden"
        >
          {triggerContent}
        </span>
