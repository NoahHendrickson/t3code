...
// ships channel-specific art. resolveDesktopWebAssetBrand stays deleted — it
// has no production caller after packaging switched to FORK_WEB_ICON_ASSETS
// (upstream re-added it alongside preview builds in #8182; still uncalled here).
